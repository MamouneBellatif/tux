...
public class EnvText {
    ...
    /**
     * Teste si un code clavier correspond bien à un chiffre
     *
     * @return true si le code est un chiffre
     */
    public Boolean isNumber(int codeKey) {
        return   codeKey == Keyboard.KEY_0 || codeKey == Keyboard.KEY_1 || codeKey == Keyboard.KEY_2 || codeKey == Keyboard.KEY_3 || codeKey == Keyboard.KEY_4
                || codeKey == Keyboard.KEY_5 || codeKey == Keyboard.KEY_6 || codeKey == Keyboard.KEY_7 || codeKey == Keyboard.KEY_8 || codeKey == Keyboard.KEY_9
                || codeKey == Keyboard.KEY_BACK  
                || codeKey == Keyboard.KEY_SPACE
                || codeKey == Keyboard.KEY_NUMPAD0
                || codeKey == Keyboard.KEY_NUMPAD1
                || codeKey == Keyboard.KEY_NUMPAD2
                || codeKey == Keyboard.KEY_NUMPAD3
                || codeKey == Keyboard.KEY_NUMPAD4
                || codeKey == Keyboard.KEY_NUMPAD5
                || codeKey == Keyboard.KEY_NUMPAD6
                || codeKey == Keyboard.KEY_NUMPAD7
                || codeKey == Keyboard.KEY_NUMPAD8
                || codeKey == Keyboard.KEY_NUMPAD9
                ;
    }
    ...
    /**
     * Récupère un nombre à partir d'un code clavier
     *
     * @return un nombre au format String
     */
    public String getNumber(int letterKeyCode) {
        env.advanceOneFrame();
        String letterStr = "";
        if ((letterKeyCode == Keyboard.KEY_SUBTRACT || letterKeyCode == Keyboard.KEY_MINUS)) {
            letterStr = "-";
        ...
        return letterStr.replaceAll("NUMPAD","");
    }
    ...
    public String lire(boolean affiche) {
        ...
        /**
     * Cette fonction permet la gestion de la saisie d'un nombre par l'utilisateur
     *
     * @return
     */
    public String lireNombre(boolean affiche) {
        int touche = 0;
        String mot = "";
        while (!(mot.length() > 0 && touche == Keyboard.KEY_RETURN)) {
            touche = 0;
            while (!isNumber(touche) && touche != Keyboard.KEY_MINUS && touche != Keyboard.KEY_SUBTRACT && touche != Keyboard.KEY_RETURN) {
                touche = env.getKey();
                env.advanceOneFrame();
            }
            if (touche != Keyboard.KEY_RETURN) {
